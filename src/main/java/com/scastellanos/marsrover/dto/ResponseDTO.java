...
/**
 * This class represent the response of execute a set of commands. It contains the initial coordinates of the rove and the finals after process the commands.
 * @author scastellanos
 *
 */
